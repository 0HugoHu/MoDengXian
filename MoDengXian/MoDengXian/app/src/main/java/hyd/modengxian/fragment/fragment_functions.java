...
import hyd.modengxian.data.DataServer;
import hyd.modengxian.entity.MultipleItem;
import hyd.modengxian.service.FloatingService;
import hyd.modengxian.service.FloatingService_Plain;
...
public class fragment_functions extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_fuctions, container, false);
        } else {
        ...
        t1 = view.findViewById(R.id.f_tab_1);
        t2 = view.findViewById(R.id.f_tab_2);
        t3 = view.findViewById(R.id.f_tab_3);
        t4 = view.findViewById(R.id.f_tab_4);
        t5 = view.findViewById(R.id.f_tab_5);
    ...
    public void showFragment(int category){
        ...
        final MultipleItemQuickAdapter multipleItemAdapter = new MultipleItemQuickAdapter(getActivity(), data);
        ...
        multipleItemAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                if (Patterns.WEB_URL.matcher(Objects.requireNonNull(Urls.get(position))).matches() || URLUtil.isValidUrl(Urls.get(position))) {
                    SharedPreferences sp = getActivity().getSharedPreferences("Temp", MODE_PRIVATE);
                    ...
                    final SharedPreferences sp=getActivity().getSharedPreferences("Temp", MODE_PRIVATE);
                    SharedPreferences.Editor edit = sp.edit();
                    edit.putString("Content",Urls.get(position));
                    edit.commit();
                    Intent intent = new Intent(getActivity(), FloatingService_Plain.class);
                    getActivity().startService(intent);
                }
            }
        });
