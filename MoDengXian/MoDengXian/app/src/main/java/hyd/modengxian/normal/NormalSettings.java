...
public class NormalSettings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refreshUI();
        getSupportActionBar().setTitle("常规");

        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(NormalSettings.this, MainActivity.class);
        ...
        fragment_normal_settings fragment = new fragment_normal_settings();
    ...
    public void refreshUI(){
        ThemeUtils.refreshUI(NormalSettings.this, new ThemeUtils.ExtraRefreshable() {
                    @Override
                    public void refreshGlobal(Activity activity) {
                        //for global setting, just do once
                        final NormalSettings context = NormalSettings.this;
