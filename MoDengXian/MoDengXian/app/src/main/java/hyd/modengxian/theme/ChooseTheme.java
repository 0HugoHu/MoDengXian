...
public class ChooseTheme extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(ChooseTheme.this, MainActivity.class);
        ...
        fragment_theme fragment = new fragment_theme();
    ...
    public void refreshUI(){
        ThemeUtils.refreshUI(ChooseTheme.this, new ThemeUtils.ExtraRefreshable() {
                    @Override
                    public void refreshGlobal(Activity activity) {
                        //for global setting, just do once
                        final ChooseTheme context = ChooseTheme.this;
