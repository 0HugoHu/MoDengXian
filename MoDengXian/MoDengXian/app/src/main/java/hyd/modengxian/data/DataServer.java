package hyd.modengxian.data;
import java.util.ArrayList;
import java.util.List;

import hyd.modengxian.R;
import hyd.modengxian.entity.MultipleItem;
import hyd.modengxian.entity.MySection;
import hyd.modengxian.entity.NormalMultipleEntity;
import hyd.modengxian.entity.SectionMultipleItem;
import hyd.modengxian.entity.Status;
import hyd.modengxian.entity.Video;
...
//************************* 数据源 **************************************************
    public static List<MultipleItem> getMultipleItemData() {
        List<MultipleItem> list = new ArrayList<>();
            ...
            list.add(new MultipleItem(MultipleItem.TEXT, MultipleItem.TEXT_SPAN_SIZE,"你好啊","这是一段话",R.drawable.icon,""));
