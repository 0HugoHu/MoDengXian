...
********2018 12 07********        Version d 1.1   Code:2
Dev：
    1.完成图文显示布局

********2018 12 08********        Version d 1.2   Code:3
Dev：
    1.调整已有内容布局
    2.加入收藏、游戏与放松版块（仅实现布局）

********2018 12 09********        Version d 2.0   Code:4
Dev：
...
********2018 12 17********        Version d 2.1   Code:5
Dev：
    1.规范变量命名（未完成）
    2.确定基本版块
...
********2018 12 18********        Version d 2.2   Code:6
Dev：
    1.规范变量命名（完成）
    2.按钮大小等细节布局调整
    3.实现按钮点击切换图标
...
********2018 12 18********        Version d 3.0   Code:7
Dev：
    1.实现辅助功能的文字内容获取（仅针对TextView）
    2.项目添加到GitHub
